...
import com.zuture.downloaderignew.utils.IOUtils
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nativeAd = NativeAd(this, "212981387339971_212981594006617")
        ...
        nativeAdtwo = NativeAd(
            this,
            "212981387339971_212981594006617"
        )
            ...
            override fun onPageSelected(position: Int) {
                if (position==1)
                    interstitialAd = InterstitialAd(
                        this@MainActivity,
                        "212981387339971_212981747339935"
                    )
