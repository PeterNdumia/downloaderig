...
import com.zuture.downloaderignew.adapters.Adapter_VideoFolder
import com.zuture.downloaderignew.models.Model_Video
import com.zuture.downloaderignew.utils.Constants.DOWNLOAD_DIRECTORY
...
class gallery : Fragment()  {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recyclerView1 = view.recyclerView
         ...
         recyclerViewLayoutManager = GridLayoutManager(
             context!!,
             3
